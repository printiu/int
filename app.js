...
// 环境变量
const UUID = process.env.UUID || '613c1d38-9a54-4fa6-8da5-8e3c389a3ff2'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const SUB_PATH = process.env.SUB_PATH || '666';            // 节点订阅路径
const XPATH = process.env.XPATH || 'R10szz555wuWi';                // xhttp路径
